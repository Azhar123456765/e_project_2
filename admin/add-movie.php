        ...
        <div class="main-panel">
            ...
            <div class="container">
                <div class="page-inner">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form action="backend/add-movie.php" method="POST">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-lg-6">
                                                <div class="form-group">
                                                    <label for="email2">Director Name</label>
                                            ...
                                            <div class="col-md-6 col-lg-6">
                                                <div class="form-group">
                                                    <label for="email2">Writer Name</label>
                                            ...
                                            <div class="col-md-6 col-lg-6">
                                                <div class="form-group">
                                                    <label for="email2">Run Time (Minutes)</label>
                                                    <input type="number" name="run_time" class="form-control"
                                                        id="run_time" />
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-select form-select-lg" name="theater">
                                            ...
                                            <div class="col-md-6 col-lg-6">
                                                <div class="form-group">
                                                    <label for="email2">Trailer Link</label>
                                            ...
                                            <div class="col-md-6 col-lg-6">
                                                <div class="form-group">
                                                    <label for="email2">Cover Picture</label>
                                                    <input type="file" accept="iamge/*" name="cover_picture"
                                                        class="form-control" id="cover_picture" />
                                                </div>
                                            </div>
